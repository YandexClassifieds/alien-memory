      ...
      test("deep sequence handlers") {
        ...
        assertTrue(
          a1Handle.offset0 == 0 && a1Handle.step1 == 2000 &&
            a1Handle.offset1 == 0 && a1Handle.step2 == 4 && a2Handle.offset2 == 0,
          a2Handle.offset0 == 0 && a2Handle.step1 == 2000 &&
            a2Handle.offset1 == 404 && a2Handle.step2 == 8 && a2Handle.offset2 == 0,
          b1zHandle.offset0 == 400_000 && b1zHandle.step1 == 404 &&
            b1zHandle.offset1 == 0 && b1zHandle.step2 == 4 && b1zHandle.offset2 == 0,
