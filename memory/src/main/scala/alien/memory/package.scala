...
package object memory extends Pow2Constants with NatConstants with MemoryHandleSyntax {
  ...
  implicit final class LayoutOps[L <: Layout](private val layout: L) extends AnyVal {
