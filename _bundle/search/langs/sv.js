...
// node_modules/lunr-languages/lunr.sv.js
var require_lunr_sv = __commonJS({
  "node_modules/lunr-languages/lunr.sv.js"(exports, module2) {
    "use strict";
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(factory);
      ...
      return function(lunr) {
        ...
        lunr.sv.stemmer = function() {
          var Among = lunr.stemmerSupport.Among, SnowballProgram = lunr.stemmerSupport.SnowballProgram, st = new function SwedishStemmer() {
            var a_0 = [
              new Among("a", -1, 1),
              new Among("arna", 0, 1),
              new Among("erna", 0, 1),
              ...
              0,
              32
            ], g_s_ending = [119, 127, 149], I_x, I_p1, sbp = new SnowballProgram();
